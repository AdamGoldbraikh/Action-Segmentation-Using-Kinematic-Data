# TCRRNet: Temporal Convolutional Recurrent Refinement Networks for Action Segmentation Using Sensor-Augmented Kinematics
This manuscript is presently being reviewed by a peer-reviewed journal.


A PyTorch implementation of the paper [TCRRNet: Temporal Convolutional Recurrent Refinement Networks for Action Segmentation Using Sensor-Augmented Kinematics](https://arxiv.org/pdf/2303.07814.pdf).
